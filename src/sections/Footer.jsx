  ...
  return (
   <section className='c-space pt-7 pb-5 border-t border-black-300 flex justify-center items-center flex-wrap gap-5'>
        <div className='flex gap-3 justify-center items-center'>
                <a className='social-icon' href='https://github.com/GSSKB' target="_blank" rel='noreferrer'>
                    <img src='/assets/github.svg' alt='github' className='w-1/2 h-1/2'/>
                </a>
                <a className='social-icon' href='https://www.linkedin.com/in/krishnagunupudi26/' target="_blank" rel='noreferrer'>
