        ...
        <header className='fixed top-0 left-0 right-0 z-50 bg-black/90'>
            <div className="max-w-7xl mx-auto">
                <div className='flex justify-between items-center py-5 mx-auto c-space'>
                    <a href='/' className='flex items-center gap-2 text-neutral-400 font-bold text-2xl hover:text-white transition-colors'>
                        <img src='/assets/logo.png' alt='Logo' className='w-8 h-8 hover:scale-105 transition-transform' />
                        Krishna Gunupudi
                    </a>
                    <button
